...
import { getInterviewStats, getResponsesPaginated, PAGE_SIZE } from "@/lib/data/responses";
...
export default async function InterviewDetailPage(props: PageProps<"/interviews/[interviewId]">) {
  ...
  const [interview, { data: responses, total }, stats, interviewers] = await Promise.all([
