...
import { createResponse, getResponseEmailsAction, updateResponse } from "@/actions/responses";
...
export default function Call({ interview }: InterviewProps) {
  ...
  return (
    <div className="flex h-screen items-center justify-center bg-background px-4">
      {isStarted && !isEnded && (
        <TabSwitchWarning isDialogOpen={tabSwitchDialogOpen} onUnderstand={handleUnderstand} />
      )}
